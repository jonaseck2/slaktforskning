...
export const commands = {
	...
	genneyImport: (repoRoot: string, sourcePath: string, dbPath: string, mediaDir: string | null, destMediaDir: string | null, schema: string | null) => typedError<GenneyImportResult, string>(__TAURI_INVOKE("genneyImport", { repoRoot, sourcePath, dbPath, mediaDir, destMediaDir, schema })),
