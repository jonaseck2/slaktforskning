export default {
  ...
  importExport: {
    ...
    genneyDerbyTitle: 'Import directly from Genney database',
    genneyDerbyDesc: 'Imports directly from Genney\'s Apache Derby database (.gcc, .backup or database folder). Requires Docker.',
    genneyDerbySelectFolder: 'Select database folder…',
    genneyDerbySelectArchive: 'Select .gcc / .backup file…',
    genneyDerbyNoDocker: 'Docker not found. Install Docker Desktop and try again, or export as GEDCOM from Genney.',
