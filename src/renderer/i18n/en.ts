export default {
  ...
  htmlSite: {
    ...
    format: 'Format',
    formatSplit: 'Two files (for web hosting)',
    formatSplitHint: 'Smaller bundle; suits GitHub Pages, Netlify, etc. Cannot be opened directly by double-click.',
    formatPortable: 'Single file (portable)',
    formatPortableHint: 'Larger bundle but opens directly in a browser without a web server. Good for email or USB stick.',
    exporting: 'Exporting…',
