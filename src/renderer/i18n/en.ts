export default {
  ...
  importExport: {
    ...
    holgerEdbTitle: 'Holger / OurKind ElevateDB (direct)',
    holgerEdbDesc: 'Import directly from the OurKind database directory (ourkind_V8 containing Perstab.EDBTbl etc.). Requires Docker.',
    holgerEdbPickDir: 'Select database directory…',
    holgerEdbImport: 'Import',
    holgerEdbRunning: 'Importing EDB database…',
    holgerEdbSuccess: 'Import complete: {persons} persons, {events} events.',
    holgerEdbError: 'EDB import failed: {error}',
