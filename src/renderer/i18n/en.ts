export default {
  ...
  gedcom: {
    ...
    export70Desc: 'Exports the entire tree as a GEDCOM 7.0 file. The current standard (2021), supported by modern genealogy applications.',
  ...
  importExport: {
    ...
    genneyGccTitle: 'Import .gcc',
    genneyGccDesc: 'Imports directly from a Genney .gcc archive. Requires Docker Desktop.',
    genneyGccButton: 'Import .gcc',
    genneyBackupTitle: 'Import .backup',
    genneyBackupDesc: 'Imports directly from a Genney .backup archive. Requires Docker Desktop.',
    genneyBackupButton: 'Import .backup',
    genneyGedcomTitle: 'Import GEDCOM',
    genneyGedcomDesc: 'Imports a GEDCOM file exported from Genney. Use this if you do not have Docker.',
    ...
    holgerTitle: 'Import Holger / OurKind',
    holgerDesc: 'Imports a GEDCOM file exported from Holger 8 or OurKind. Accepts both .ged and .zip files.',
    ...
    gedcomImportDesc: 'Imports a GEDCOM file from any genealogy application. Both 5.5.1 and 7.0 are supported.',
