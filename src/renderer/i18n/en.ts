export default {
  ...
  htmlSite: {
    ...
    focusPersonHint: 'Search and select a person whose family tree will be exported.',
    scope: 'Data scope',
    ...
    exporting: 'Exporting…',
    exportSingleFile: 'Export without media to browser file',
    exportingSingleFile: 'Exporting file…',
