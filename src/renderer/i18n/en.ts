export default {
  ...
  common: {
    ...
    close: 'Close',
    open: 'Open',
    monospacedTooltip: 'Toggle between proportional and monospaced font for notes',
  ...
  persons: {
    ...
    noMatchesHint: 'No people match your search. Try a different name or clear the search.',
    ...
    columnPicker: {
      title: 'Columns',
      openLabel: 'Columns',
      help: 'Choose which columns show in the persons list. Count columns help you find sparse records — sort ascending to see persons that need more work first.',
      alwaysVisible: 'always visible',
      sortStatus: 'Sort: {primary} {primaryDir}, {secondary} {secondaryDir}',
      clearSecondary: 'Clear secondary sort',
    },
  },
  personDetail: {
    deceased: 'Deceased',
  ...
  relationshipDetail: {
    ...
    subtype: 'Subtype',
    subtypeFreePlaceholder: 'e.g. half, step, best friend',
  ...
  repositories: {
    ...
    name: 'Name',
    namePlaceholder: 'National Archives, City Library…',
    address: 'Address',
    city: 'City',
    ...
    emptyDesc: 'Add a repository so sources can record where they are kept.',
    countLabel: 'Showing {shown} of {total} repositories',
    deleteTitle: 'Delete repository',
    deleteWarning: 'Removes the repository and unlinks it from any sources.',
    deleteConfirmMessage: '"{name}" will be removed. Links to {sources} source(s) are removed too. This cannot be undone.',
    deletedToast: '"{name}" was removed.',
    confirmDelete: 'Delete this repository? This cannot be undone.',
    removeConfirmTitle: 'Delete repository?',
    filterSearch: 'Search repositories',
    addToSource: 'Repository',
    unlinkFromSource: 'Unlink from source',
    unlinkConfirmTitle: 'Unlink from source?',
    confirmUnlink: 'Remove the link between this source and the repository?',
    noRepositories: 'No repositories',
    noSources: 'No sources in this repository.',
    panelNoneSelected: 'Click a repository in the list',
    sourcesAt: 'Sources at this repository',
  },
  taskPanel: {
  ...
  events: {
    ...
    causeOptionalPlaceholder: 'Cause (if relevant)',
    placeAddress: 'Address (specific)',
    placeAddressPlaceholder: 'e.g. 12 Main St, Apt 3',
  ...
  citations: {
    ...
    pageLocation: 'Page / Location / URL',
  ...
  places: {
    ...
    lifecycleDates: 'Existed during',
    dateFrom: 'Existed from',
    dateTo: 'Existed until',
    eventCount: 'Events',
    yearsHeader: 'Years',
    hierarchy: 'Hierarchy',
  ...
  duplicates: {
    ...
    hint: 'Persons, places, sources and media that may be registered twice. Click "Merge" to move data from the source onto the target and delete the duplicate row.',
    ...
    keepEntity: 'Keep (target)',
    mergeEntity: 'Merge & delete (source)',
    ...
    mergeComingSoon: 'Merging here is on the way — coming in the next step.',
    confirmMerge: 'Merge',
    merging: 'Merging...',
    ignore: 'Ignore',
    ...
    empty: {
      persons: 'No duplicate persons found.',
      places: 'No duplicate places found.',
      sources: 'No duplicate sources found.',
      media: 'No duplicate media found.',
    },
    field: 'Field',
    mergedToast: 'Merged',
    places: {
      parented: 'with parent place',
      mergeTitle: 'Merge places',
      confirmTitle: 'Merge place?',
      confirmMerge: 'Will merge "{name}" into the selected place.',
      confirmCascade: 'All events, citations, child places, and links will be moved.',
    },
    sources: {
      mergeTitle: 'Merge sources',
      confirmTitle: 'Merge source?',
      confirmMerge: 'Will merge "{title}" into the selected source.',
      confirmCascade: 'All citations and repository links will be moved.',
    },
    media: {
      mergeTitle: 'Merge media',
      confirmTitle: 'Merge media?',
      confirmMerge: 'Will merge "{title}" into the selected media.',
      confirmDelete: 'The file "{file}" will be deleted from disk.',
      confirmCascade: 'All links and face tags will be moved.',
      keepFileLegend: 'File on disk',
      keepFileHint: 'The two media point to different files on disk. Choose which file to keep — the other will be deleted.',
      keepTargetFile: 'Keep target\'s file',
      keepSourceFile: 'Keep source\'s file',
      noFile: '(no file on disk)',
      bothNoFile: 'Neither side has a file on disk — nothing will be deleted.',
      targetNoFile: 'The target has no file. The source\'s file will be kept.',
      sourceNoFile: 'The source has no file. The target\'s file will be kept.',
    },
    reasons: {
  ...
  notes: {
    ...
    text: 'Text',
    language: 'Language',
    languageHint: 'BCP 47 code, e.g. sv, en, de, ru, zh',
    addTitle: 'Add note',
    editTitle: 'Edit note',
    deleteTitle: 'Delete note',
    deleteWarning: 'Removes the note from every linked entity.',
  ...
  importExport: {
    ...
    queueFilesLabel: 'Files ({count}):',
    consolidateTitle: 'Things that arrived more than once',
    consolidateIntro: 'Nothing is joined until you say so.',
    ...
    consolidateApprove: 'Join',
    consolidateDecline: 'Keep separate',
    consolidateExact: 'Same identifier',
    consolidateFuzzy: 'Looks similar',
    consolidateClose: 'Done',
    queueFileFailed: '{file}: {error}',
    queueSummary: '{succeeded} of {total} files imported',
  ...
  media: {
    ...
    caption: 'Caption',
    formatLabel: 'Format',
    formatPlaceholder: 'e.g. jpeg, pdf',
  ...
  updater: {
    ...
    installedRestart: 'Update installed. Restart Släktforskning to apply.',
