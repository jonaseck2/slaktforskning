export default {
  ...
  quality: {
    ...
    checks: {
      ...
      UNRESOLVED_EVIDENCE_CONFLICT: 'Unresolved evidence conflict: {attribute} ({values})',
    },
  },
  duplicates: {
  ...
  assertions: {
    ...
    notesPlaceholder: 'Why do you accept or reject this claim?',
    noAssertions: 'No assertions yet.',
    conflictCount: '{count} conflict | {count} conflicts',
    claimCount: '{count} claim | {count} claims',
    extractClaims: 'Extract Claims',
    addAssertion: 'Add Claim',
    conflict: 'Conflict',
    accepted: 'Accepted',
    rejected: 'Rejected',
    source: 'Source',
