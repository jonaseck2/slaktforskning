export default {
  ...
  importExport: {
    ...
    genneyArchiveTitle: 'Archive (.gcc / .backup)',
    genneyArchiveDesc: 'Import directly from a Genney archive file. Requires Docker Desktop.',
    genneyArchiveButton: 'Select archive file',
    genneyFolderTitle: 'Derby database folder',
    genneyFolderDesc: 'Import directly from an unpacked Genney Derby database folder. Requires Docker Desktop.',
    genneyFolderButton: 'Select folder',
    genneyGedcomTitle: 'GEDCOM export',
    genneyGedcomDesc: 'Import a .ged file exported from Genney. In Genney: File → Export GEDCOM (.ged) → Save.',
    genneyGedcomButton: 'Select .ged file',
    ...
    holgerDesc: 'Import from a Holger 8 GEDCOM export (.ged or .zip). Export from Holger: File → Export GEDCOM → General format, ANSI.',
