export default {
  ...
  persons: {
    ...
    noMatchesTitle: 'Inga matchande personer',
    noMatchesHint: 'Inga personer matchar din sökning. Prova ett annat namn eller rensa sökningen.',
  ...
  importExport: {
    ...
    queueFilesLabel: 'Filer ({count}):',
    consolidateTitle: 'Sådant som kom in flera gånger',
    consolidateIntro: 'Inget slås ihop förrän du säger till.',
    ...
    consolidateApprove: 'Slå ihop',
    consolidateDecline: 'Behåll separat',
    consolidateExact: 'Samma identifierare',
    consolidateFuzzy: 'Liknar varandra',
    consolidateClose: 'Klar',
    queueFileFailed: '{file}: {error}',
    queueSummary: '{succeeded} av {total} filer inlästa',
