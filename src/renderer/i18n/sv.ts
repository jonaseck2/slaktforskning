export default {
  ...
  quality: {
    ...
    checks: {
      ...
      UNRESOLVED_EVIDENCE_CONFLICT: 'Olöst beviskonflikt: {attribute} ({values})',
    },
  },
  duplicates: {
  ...
  assertions: {
    nav: 'Bevis',
    title: 'Bevisanalys',
    loading: 'Laddar bevisdata...',
    summary: '{total} påståenden · {conflicts} konflikter',
    filterAll: 'Alla',
    filterConflicts: 'Konflikter ({count})',
    filterUnaccepted: 'Ej godkända',
    noConflicts: 'Inga konflikter hittades.',
    subjectHeader: 'Subjekt',
    addTitle: 'Nytt påstående',
    editTitle: 'Redigera påstående',
    attribute: 'Attribut',
    value: 'Påstått värde',
    valueOriginal: 'Originaltext',
    confidence: 'Tillförlitlighet',
    evidenceType: 'Bevistyp',
    evidenceTypes: {
      direct: 'Direkt',
      indirect: 'Indirekt',
      negative: 'Negativt',
    },
    isAccepted: 'Accepterat',
    notes: 'Analysanteckningar',
    notesPlaceholder: 'Varför godkänner eller avvisar du detta påstående?',
    noAssertions: 'Inga påståenden ännu.',
    conflictCount: '{count} konflikt | {count} konflikter',
    claimCount: '{count} påstående | {count} påståenden',
    extractClaims: 'Extrahera påståenden',
    addAssertion: 'Nytt påstående',
    conflict: 'Konflikt',
    accepted: 'Godkänt',
    rejected: 'Avvisat',
    source: 'Källa',
