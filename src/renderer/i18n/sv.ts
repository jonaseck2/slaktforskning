export default {
  ...
  importExport: {
    ...
    holgerEdbTitle: 'Holger / OurKind ElevateDB (direkt)',
    holgerEdbDesc: 'Importera direkt från OurKind-databasen (mappen ourkind_V8 som innehåller Perstab.EDBTbl etc.). Kräver Docker.',
    holgerEdbPickDir: 'Välj databaskatalog…',
    holgerEdbImport: 'Importera',
    holgerEdbRunning: 'Importerar EDB-databas…',
    holgerEdbSuccess: 'Import klar: {persons} personer, {events} händelser.',
    holgerEdbError: 'EDB-import misslyckades: {error}',
