export default {
  ...
  importExport: {
    ...
    genneyDerbyTitle: 'Importera direkt från Genney-databasen',
    genneyDerbyDesc: 'Importerar direkt från Genneys Apache Derby-databas (.gcc, .backup eller databasmapp). Kräver Docker.',
    genneyDerbySelectFolder: 'Välj databasmapp…',
    genneyDerbySelectArchive: 'Välj .gcc / .backup-fil…',
    genneyDerbyNoDocker: 'Docker hittades inte. Installera Docker Desktop och försök igen, eller exportera som GEDCOM från Genney.',
