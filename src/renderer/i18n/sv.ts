export default {
  ...
  settings: {
    ...
    off: 'Av',
    narrate: 'Berätta',
    screenReaderMode: 'Skärmläsar-läge',
  },
  common: {
    cancel: 'Avbryt',
    delete: 'Ta bort',
  ...
  screenReader: {
    welcome: 'Skärmläsar-läge aktivt. Tryck frågetecken för tillgängliga kommandon.',
    modeOff: 'Skärmläsar-läge avaktiverat.',
    ...
    navSourcesList: 'Källor, {count} källor',
