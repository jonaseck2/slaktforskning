export default {
  ...
  relationships: {
    ...
    emptyState: 'Inga relationer ännu. Klicka \u201CRelation\u201D för att börja.',
    person1: 'Person 1',
    person2: 'Person 2',
  ...
  sources: {
    title: 'Källor',
    addSource: 'Källa',
    emptyState: 'Inga källor ännu. Klicka \u201CKälla\u201D för att börja.',
    sourceTitle: 'Titel',
    author: 'Författare',
    sourceType: 'Källtyp',
    selectType: '\u2014 Välj \u2014',
  ...
  duplicates: {
    ...
    noDuplicates: 'Inga möjliga dubbletter hittades.',
    score: 'Poäng',
  ...
  reports: {
    ...
    noEventsForPlace: 'Inga händelser registrerade för denna plats.',
    fanChart: 'Solfjäder',
  ...
  gazetteers: {
    ...
    noGazetteers: 'Inga ortsregister installerade.',
    importBtn: 'Importera',
