export default {
  ...
  htmlSite: {
    ...
    focusPersonHint: 'Sök och välj en person vars släktträd ska exporteras.',
    scope: 'Dataomfång',
    ...
    exportingSingleFile: 'Exporterar fil…',
    exportSingleFile: 'Exportera utan mediafiler till webbläsarfil',
    exportedTo: 'Exporterades till',
    mediaCount: '{count} filer',
