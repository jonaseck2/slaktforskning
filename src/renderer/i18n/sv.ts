export default {
  ...
  gedcom: {
    ...
    export70Desc: 'Exporterar hela trädet som en GEDCOM 7.0-fil. Den nuvarande standarden (2021), stöds av moderna släktforskningsprogram.',
  ...
  importExport: {
    ...
    genneyGccTitle: 'Importera .gcc',
    genneyGccDesc: 'Importerar direkt från ett Genney .gcc-arkiv. Kräver Docker Desktop.',
    genneyGccButton: 'Importera .gcc',
    genneyBackupTitle: 'Importera .backup',
    genneyBackupDesc: 'Importerar direkt från ett Genney .backup-arkiv. Kräver Docker Desktop.',
    genneyBackupButton: 'Importera .backup',
    genneyGedcomTitle: 'Importera GEDCOM',
    genneyGedcomDesc: 'Importerar en GEDCOM-fil exporterad från Genney. Använd detta alternativ om du inte har Docker.',
    ...
    holgerTitle: 'Importera Holger / OurKind',
    holgerDesc: 'Importerar en GEDCOM-fil exporterad från Holger 8 eller OurKind. Stöder både .ged- och .zip-filer.',
    ...
    gedcomImportDesc: 'Importerar en GEDCOM-fil från valfritt program. Både 5.5.1 och 7.0 stöds.',
