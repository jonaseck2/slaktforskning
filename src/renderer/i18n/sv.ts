export default {
  ...
  importExport: {
    ...
    genneyArchiveTitle: 'Arkiv (.gcc / .backup)',
    genneyArchiveDesc: 'Importera direkt från en Genney-arkivfil. Kräver Docker Desktop.',
    genneyArchiveButton: 'Välj arkivfil',
    genneyFolderTitle: 'Derby-databasmapp',
    genneyFolderDesc: 'Importera direkt från en uppackad Genney Derby-databasmapp. Kräver Docker Desktop.',
    genneyFolderButton: 'Välj mapp',
    genneyGedcomTitle: 'GEDCOM-export',
    genneyGedcomDesc: 'Importera en .ged-fil exporterad från Genney. I Genney: Arkiv → Exportera GEDCOM (.ged) → Spara.',
    genneyGedcomButton: 'Välj .ged-fil',
    ...
    holgerDesc: 'Importera från en Holger 8 GEDCOM-export (.ged eller .zip). Exportera från Holger: Arkiv → Exportera GEDCOM → Generellt format, ANSI.',
