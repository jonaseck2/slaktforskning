export default {
  ...
  chart: {
    ...
    legend: {
      ...
      adoptiveRelationship: 'Adoptivt f\u00f6rh\u00e5llande',
    },
    tooltip: {
      fosterRelationship: 'Fosterf\u00f6rh\u00e5llande',
  ...
  htmlSite: {
    ...
    format: 'Format',
    formatSplit: 'Två filer (för webbserver)',
    formatSplitHint: 'Mindre paket; passar GitHub Pages, Netlify och liknande. Kan inte öppnas direkt med dubbelklick.',
    formatPortable: 'En enda fil (portabel)',
    formatPortableHint: 'Större paket men öppnas direkt i webbläsaren utan webbserver. Bra för e-post och USB-minne.',
