...
export function getEventsForFamily(db: Database.Database, familyId: string): GenealogyEvent[] {
...
export function deleteEvent(db: Database.Database, id: string): boolean {
