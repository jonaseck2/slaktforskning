...
const api = {
  persons: {
    ...
    listPage: (limit: number, offset: number, sortBy?: 'surname' | 'given_name' | 'birth_date', sortDir?: 'asc' | 'desc', query?: string) => ipcRenderer.invoke('persons:listPage', limit, offset, sortBy, sortDir, query),
