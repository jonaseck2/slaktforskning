...
| v0.44.0 | TTS auto-read on navigation + settings toggle — auto-narrates person/relationship/source on load when enabled, provide/inject pattern, stop on route leave | [plan](plans/2026-04-08-accessibility-tts.md) |
---
