...
- [ ] Step 1: Refactor `src/gedcom/importer.ts` → `src/import/gedcom/` (pure refactor, no behavior change)
- [ ] Step 2: Version detection + 5.5.5 acceptance (parse identically to 5.5.1)
