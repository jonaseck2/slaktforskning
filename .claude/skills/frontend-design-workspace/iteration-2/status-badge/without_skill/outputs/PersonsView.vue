      ...
      <table class="data-table">
        ...
        <tbody>
          ...
          >
            ...
            <td>
              <span v-if="person.living" class="status-badge status-living">{{ $t('personDetail.statusLiving') }}</span>
              <span v-else class="status-badge status-deceased">{{ $t('personDetail.statusDeceased') }}</span>
            </td>
