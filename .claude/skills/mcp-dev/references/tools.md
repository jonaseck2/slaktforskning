...
| `add_person_name` | Add an alternate name (married, alias, aka) with optional prefix/suffix/qualifier |
| `get_person_names` | Get all names for a person |
| `update_person_name` | Update a name record (including prefix/suffix/qualifier) |
| `delete_person_name` | Delete a name record |
| `add_person_identifier` | Add an external identifier (FamilySearch ID, Ancestry ID, etc.) |
| `get_person_identifiers` | Get all external identifiers for a person |
| `delete_person_identifier` | Delete an external identifier |
