...
- [x] **ResearchTasksView** — global list at `/research-tasks`
...
- [x] **PersonDetailView integration** — section "Forskningstips" below events
  - Inline task list (compact: status chip + task text + result if set)
  - "Add task" button opens modal pre-filled with this person
- [x] **Sidebar entry** — "Forskning" with badge showing count of open+in_progress tasks
- [x] **i18n** — sv.ts + en.ts for all new strings
- [x] **Docs** — update PLAN.md
