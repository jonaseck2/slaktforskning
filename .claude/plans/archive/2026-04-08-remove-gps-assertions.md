...
- [ ] Update .claude/PLAN.md: mark this milestone complete
- [ ] Update .claude/MCP.md: remove assertion tools section
- [ ] Update .claude/IPC_REFERENCE.md: remove assertion channels
