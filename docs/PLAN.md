...
| v0.120.0 | feat(media): set profile picture from face-tag star or media-row star | [spec](superpowers/specs/archive/2026-04-19-set-profile-from-face-tag-design.md) |
...
| v0.122.0 | feat(picker): relation + dates hint in PersonPicker — role label (parent/child/partner/sibling/godparent) to the tree's default person + (*YYYY–†YYYY) pulled from primary-role birth/death events | [spec](superpowers/specs/archive/2026-04-19-person-picker-relation-hint-design.md) |
