...
- Modify: `docs/PLAN.md` (add milestone)
...
- [ ] **Step 3: Add milestone to `docs/PLAN.md`**

In `docs/PLAN.md`, add a row to the Implementation Status table after the v0.25.0 row:

```
| v0.26.0 | Infinite chart expansion: lazy load-more per branch, pedigree arrow ▶ fix | [plan](docs/plans/2026-04-06-infinite-chart-expansion.md) |
```

- [ ] **Step 4: Final commit**

```bash
git add package.json docs/PLAN.md docs/plans/2026-04-06-infinite-chart-expansion.md
