...
**Design spec:** `docs/plans/2026-04-03-visualization.md`
**Brainstorm mockups:** `docs/plans/brainstorm/2026-04-03-visualization/viz-mockup.html`
...
- [ ] **Step 3: Update PLAN.md checkboxes**
  ...
  In `docs/PLAN.md`, mark all v0.4.1 tasks as done.
