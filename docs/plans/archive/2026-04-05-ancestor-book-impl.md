...
All four tasks complete. The ancestor book export is available in ReportsView → Stamtavla tab. Update `docs/PLAN.md` to mark all checkboxes in the Ancestor Book Export roadmap section as done and move the plan files to archive.
