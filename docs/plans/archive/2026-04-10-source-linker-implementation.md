...
**Spec:** `docs/plans/2026-04-10-source-linker-design.md`
...
See the spec at `docs/plans/2026-04-10-source-linker-design.md` for the complete component structure (Settings section).
