...
| `docs/IPC_REFERENCE.md` | Update `gedcom:export` signature |
...
- [ ] **Step 4: Add milestone to `docs/PLAN.md`**
...
```bash
git add docs/PLAN.md docs/IPC_REFERENCE.md CLAUDE.md package.json
